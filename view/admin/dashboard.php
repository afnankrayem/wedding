...
<div class="container-fluid">
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="?action=delete&id=<?php echo $client['id'];?>"><i class="bi bi-trash delete-client"></i></a>
      <a href="?action=edit&id=<?php echo $client['id'];?>"><i class="bi bi-pencil edit-client"></i></a>
      </td>
    </tr>
    <?php endforeach; ?>
  </tbody>
